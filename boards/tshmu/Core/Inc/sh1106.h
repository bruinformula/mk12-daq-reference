...
/**
 * @brief  Handles the HAL I2C master-tx completion for the SH1106 DMA queue.
 * @retval 1 if the callback belonged to SH1106, 0 otherwise.
 */
uint8_t SH1106_HandleMasterTxCplt(I2C_HandleTypeDef *hi2c);
