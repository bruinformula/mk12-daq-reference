...
void VnCompositeData_processBinaryPacket(VnCompositeData* compositeData, VnUartPacket* packet)
{
...
void VnCompositeData_processAsciiAsyncPacket(VnCompositeData* compositeData, VnUartPacket* packet)
{
